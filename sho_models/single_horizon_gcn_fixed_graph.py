...
# Setup Logging
# ---------------------------
LOG_DIR = os.path.join(MAIN_PATH, "output/sho/logs_gcn_fixed_graph")
OUTPUT_DIR = os.path.join(MAIN_PATH, "output/sho/study_results_gcn_fixed_graph")
...
def objective(trial: optuna.Trial):
    try:
        ...
        train_loader, val_loader, _ = prepare_data(use_validation=True, prediction_horizon=DIRECT_HORIZONS_TO_PREDICT, batch_size=params["batch_size"])
